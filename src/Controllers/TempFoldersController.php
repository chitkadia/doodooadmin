<?php
/**
 * Folders related functionality (Template)
 */
...
class TempFoldersController extends AppController {
    ...
    public function lists(ServerRequestInterface $request, ResponseInterface $response, $args) {
        ...
        $query_params["type"] = SHAppComponent::getValue("app_constant/FOLDER_TYPE_TEMPLATE");
        ...
        foreach ($data["rows"] as $row) {
            ...
            if (isset($share_access["can_create"])) {
                $share_access["can_create"] = (bool) $share_access["can_create"];
            } else {
                $share_access["can_create"] = false;
            }
            ...
            $row_data = [
                ...
                "shared" => $shared,
                "shared_access" => [
                    "can_create" => $share_access["can_create"],
    ...
    public function create(ServerRequestInterface $request, ResponseInterface $response, $args) {
        ...
        try {
            $share_access = json_encode(["can_create" => false, "can_edit" => false,"can_delete" => false]);
            ...
            $save_data = [
                ...
                "type" => SHAppComponent::getValue("app_constant/FOLDER_TYPE_TEMPLATE"),
    ...
    public function view(ServerRequestInterface $request, ResponseInterface $response, $args) {
        ...
        try {
            ...
            $condition = [
                ...
                "where" => [
                    ["where" => ["at.account_folder_id", "=", $row_id]],                    
                    ["where" => ["at.status", "<>", SHAppComponent::getValue("app_constant/STATUS_DELETE")]]
                ]
            ];
            $templates_list = $model_account_templates->fetchAll($condition);
           
            foreach ($templates_list as $template) {
                $folder_templates[] = [
                    "id" => StringComponent::encodeRowId($template["id"]),
                    "name" => $template["title"]
                ];
            }
    ...
    public function delete(ServerRequestInterface $request, ResponseInterface $response, $args) {
        ...
        try {            
            // Delete templates of the folder
            $model_account_templates = new AccountTemplates();
            ...
            if ($model_account_templates->update($save_data, $condition) !== false) 
            {
                try {
                    // Delete folder
                    $save_data = [
    ...
    public function share(ServerRequestInterface $request, ResponseInterface $response, $args) {
        ...
        if (isset($request_params["can_create"])) {
            $request_data["can_create"] = (bool) $request_params["can_create"];
        }
        ...
        try {
            // Save data
            $share_access = json_encode(["can_create" => $request_data["can_create"],"can_edit" => $request_data["can_edit"], "can_delete" => $request_data["can_delete"]]);
