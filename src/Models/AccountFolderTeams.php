<?php
/**
 * Model file for operations on account_folder_teams table
 */
namespace App\Models;

class AccountFolderTeams extends AppModel {
    ...
    protected function _setTable() {
        $this->_table = "account_folder_teams";
        $this->_table_alias = "aft";
    }
     ...
     */
    public function checkShareFolderAvailable($id, $payload = []) {
        $valid = false;
