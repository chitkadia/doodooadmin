...
class AgeCategory extends AppModel {
    ...
    protected function _setTable() {
        $this->_table = "age_category";
        $this->_table_alias = "ag";
    }
    ...
    protected function _setFields() {
        $this->_fields = [
            "id" => "Id",
            "age_category_name" => "Age Category Name",
            "status" => "Status",
    ...
    public function getListData($query_params, $payload = []) {
        ...
        if (isset($query_params["query"])) {
            $search_condition = [
                "age_category_name LIKE '%" . $query_params["query"] . "%'"
            ];
        ...
        switch ($query_params["order_by"]) {
            case "age_category_name":
                $order_by = " ORDER BY age_category_name " . $query_params["order"];
                break;
