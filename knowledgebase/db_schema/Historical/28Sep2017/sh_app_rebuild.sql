...
--
-- Host: localhost
-- Generation Time: Jul 21, 2017 at 06:07 PM
...
CREATE TABLE `account_companies` (
  ...
  `logo` varchar(40) CHARACTER SET utf8 NOT NULL,
  `website` varchar(150) CHARACTER SET utf8 NOT NULL,
  `contact_phone` varchar(20) CHARACTER SET utf8 NOT NULL,
  `contact_fax` varchar(20) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `account_invoice_details` (
  ...
  `file_copy` varchar(40) CHARACTER SET utf8 NOT NULL COMMENT 'Path of PDF copy of invoice',
  `created` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'GMT+00:00 Timestamp'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `account_payment_details` (
  ...
  `tp_payment_id` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'Payment gateway payment id',
...
CREATE TABLE `account_sending_methods` (
  ...
  `connection_info` varchar(1024) CHARACTER SET utf8 NOT NULL,
  `last_error` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT 'Last error description',
  `total_mail_sent` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `total_mail_failed` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `total_mail_replied` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `total_mail_bounced` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `account_subscription_details` (
  ...
  `tp_subscription_id` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'Payment gateway subscription id',
  `tp_customer_id` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'Payment gateway customer id',
...
CREATE TABLE `activity` (
  ...
  `other_data` varchar(512) CHARACTER SET utf8 NOT NULL COMMENT 'Location and other information',
  `created` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'GMT+00:00 Timestamp'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(2, 'DB_OPERATION_FAIL', 500, 1002, 'Database query failed.', 1, 1496645339, 1496645339),
(3, 'SERVER_EXCEPTION', 500, 1003, 'Server encountered an error.', 1, 1496645339, 1496645339),
...
(7, 'SOURCE_MISSING', 406, 1007, 'Source is missing from request headers.', 1, 1496645339, 1496645339),
(8, 'INVALID_SOURCE', 406, 1008, 'Invalid source.', 1, 1496645339, 1496645339),
(9, 'REQUIRED_HEADER_MISSING', 406, 1009, 'Required headers missing from request headers.', 1, 1496645339, 1496645339),
(10, 'INVALID_HTTP_METHOD', 405, 1010, 'Invalid HTTP method.', 1, 1496645339, 1496645339),
(11, 'LOGIN_REQUIRED', 401, 1011, 'Not authorized. Please login to your account.', 1, 1496645339, 1496645339),
(12, 'NOT_AUTHORIZED', 403, 1012, 'You are not authorized to access this resource.', 1, 1496645339, 1496645339),
(13, 'UPGRADE_ACCOUNT', 402, 1013, 'Your plan doesn\'t include access to this resource.', 1, 1496645339, 1496645339),
...
(9, 'U_SIGNATURE', 'Signature', 'U_SIGNATURE', 1496645339, 1496645339),
(10, 'U_TRACK_EMAILS', 'Track Emails', 'U_TRACK_EMAILS', 1496645339, 1496645339),
(11, 'U_TRACK_REPLY', 'Reply Tracking', 'U_TRACK_REPLY', 1496645339, 1496645339),
(12, 'U_TRACK_CLICKS', 'Link Tracking', 'U_TRACK_CLICKS', 1496645339, 1496645339),
(13, 'U_POWERED_BY_SH', 'Powered By Saleshandy', 'U_POWERED_BY_SH', 1496645339, 1496645339),
(14, 'U_BCC', 'Default BCC', 'U_BCC', 1496645339, 1496645339),
(15, 'U_CC', 'Default CC', 'U_CC', 1496645339, 1496645339),
(16, 'U_TIMEZONE', 'Timezone', 'U_TIMEZONE', 1496645339, 1496645339),
(17, 'U_SNOOZE_NOTIFICATIONS', 'Snooze All Notifications', 'U_SNOOZE_NOTIFICATIONS', 1496645339, 1496645339),
...
CREATE TABLE `campaign_sequences` (
  ...
  `message_send_id` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'Id of message sent (received from mail server)',
  `sent_response` varchar(512) CHARACTER SET utf8 NOT NULL COMMENT 'Mail sending attempt response from mail server',
...
CREATE TABLE `document_master` (
  ...
  `source_document_id` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'ID of document if imported from any source',
  `source_document_link` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT 'Link of document if imported from any source',
  `public` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0-No, 1-Yes',
...
CREATE TABLE `email_master` (
  ...
  `track_reply` tinyint(1) UNSIGNED NOT NULL DEFAULT '1' COMMENT '0-No, 1-Yes',
  `track_click` tinyint(1) UNSIGNED NOT NULL DEFAULT '1' COMMENT '0-No, 1-Yes',
  `cc` varchar(512) CHARACTER SET utf8 NOT NULL,
  `bcc` varchar(512) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `email_recipients` (
  ...
  `click_count` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `last_clicked` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Last clicked date time (GMT+00:00 Timestamp)',
  `sent_message_id` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'Id of message sent (received from mail server)',
  `sent_response` varchar(512) CHARACTER SET utf8 NOT NULL COMMENT 'Mail sending attempt response from mail server',
  `is_bounce` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0-No, 1-Yes',
  `progress` tinyint(2) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0-Scheduled, 1-Sent, 2-Fail',
  `status` tinyint(2) UNSIGNED NOT NULL DEFAULT '1' COMMENT '1-Active, 2-Deleted',
...
(1, 'Login', 'Access to login to the SalesHandy account.', '[\"/user/login\", \"/user/loginwith/{method}\"]', NULL, 1, 0, 0, 1, 0, 1, 1496645339, 1496645339),
(2, 'Signup', 'Access to signup for the SalesHandy account.', '[\"/user/signup\", \"/user/verify/{code}\", \"/user/resend-verification/{code}\"]', NULL, 2, 0, 0, 1, 0, 1, 1496645339, 1496645339),
...
(24, 'Email Accounts / View', 'Access to view email accounts data.', '[\"/mail-accounts/list\", \"/mail-accounts/search\", \"/mail-accounts/{id}/view\"]', 7, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(25, 'Email Accounts / Create', 'Access to create email accounts.', '[\"/mail-accounts/create\", \"/mail-accounts/{id}/copy\"]', 7, 2, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(28, 'Emails / View', 'Access to view emails data.', '[\"/emails/list\", \"/emails/search\", \"/emails/{id}/view\"]', 8, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(32, 'Campaigns / View', 'Access to view campaigns data.', '[\"/campaigns/list\", \"/campaigns/search\", \"/campaigns/{id}/view\", \"/campaigns/{id}/view-stage/{stage_id}\", \"/campaigns/{id}/sequence-mail/{seq_id}\", \"/campaigns/{id}/export-data/{stage_id}\"]', 9, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(36, 'Documents / View', 'Access to view documents data.', '[\"/documents/list\", \"/documents/search\", \"/documents/{id}/view\", \"/documents/{id}/sharing\"]', 10, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(37, 'Documents / Create', 'Access to upload documents.', '[\"/documents/create\", \"/documents/{id}/copy\"]', 10, 2, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(41, 'Folders / View', 'Access to view folders data.', '[\"/folders/list\", \"/folders/search\", \"/folders/{id}/view\", \"/folders/{id}/sharing\"]', 11, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(42, 'Folders / Create', 'Access to create new folders.', '[\"/folders/create\", \"/folders/{id}/copy\"]', 11, 2, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(43, 'Folders / Update', 'Access to update folders data.', '[\"/folders/{id}/update\", \"/folders/{id}/mark-as-public\", \"/folders/{id}/status-update\"]', 11, 3, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(44, 'Folders / Delete', 'Access to delete folders.', '[\"/folders/{id}/delete\"]', 11, 4, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(45, 'Folders / Share', 'Access to share folders.', '[\"/folders/{id}/share\"]', 11, 5, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(46, 'Links / View', 'Access to view links.', '[\"/links/list\", \"/links/search\", \"/links/{id}/view\"]', 12, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(50, 'Templates / View', 'Access to view templates data.', '[\"/templates/list\", \"/templates/search\", \"/templates/{id}/view\", \"/templates/{id}/sharing\"]', 13, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(51, 'Templates / Create', 'Access to create new templates.', '[\"/templates/create\", \"/templates/{id}/copy\"]', 13, 2, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(52, 'Templates / Update', 'Access to update templates data.', '[\"/templates/{id}/update\", \"/templates/{id}/mark-as-public\", \"/templates/{id}/status-update\", \"/templates/{id}/move\"]', 13, 3, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(55, 'Contacts / View', 'Access to view contacts data.', '[\"/contacts/list\", \"/contacts/search\", \"/contacts/{id}/view\", \"/contacts/{id}/feed\"]', 14, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(59, 'Company / View', 'Access to view company data.', '[\"/company/list\", \"/company/search\", \"/company/{id}/view\", \"/company/{id}/feed\", \"/company/{id}/contacts\"]', 15, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(63, 'Teams / View', 'Access to view teams data.', '[\"/teams/list\", \"/teams/search\", \"/teams/{id}/view\"]', 16, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(64, 'Teams / Create', 'Access to create new team.', '[\"/teams/create\", \"/teams/{id}/copy\"]', 16, 2, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(65, 'Teams / Update', 'Access to update teams data.', '[\"/teams/{id}/update\", \"/teams/{id}/status-update\"]', 16, 3, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(66, 'Teams / Delete', 'Access to delete teams data.', '[\"/teams/{id}/delete\"]', 16, 4, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(67, 'Members / View', 'Access to view members information.', '[\"/members/list\", \"/members/search\", \"/members/{id}/view\", \"/members/{id}/resend-invitation\", \"/members/{id}/activity\", \"/members/{id}/resources\"]', 17, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(68, 'Members / Create', 'Access to create or invite new members.', '[\"/members/create\", \"/members/{id}/copy\"]', 17, 2, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(71, 'Roles / View', 'Access to view roles.', '[\"/roles/list\", \"/roles/search\", \"/roles/{id}/view\", \"/roles/resources/list\"]', 18, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(72, 'Roles / Create', 'Access to create new role.', '[\"/roles/create\", \"/roles/{id}/copy\"]', 18, 2, 1, 0, 0, 1, 1, 1496645339, 1496645339),
(73, 'Roles / Update', 'Access to update roles.', '[\"/roles/{id}/update\", \"/roles/{id}/status-update\"]', 18, 3, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(81, 'Webhooks / View', 'Access to view webhooks information.', '[\"/web-hooks/list\", \"/web-hooks/search\", \"/web-hooks/{id}/view\"]', 22, 1, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
CREATE TABLE `role_master` (
  ...
  `status` tinyint(2) UNSIGNED NOT NULL DEFAULT '1' COMMENT '0-Inactive, 1-Active, 2-Delete',
  `created` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'GMT+00:00 Timestamp',
  `modified` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'GMT+00:00 Timestamp'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `user_authentication_tokens` (
  ...
  `user_resources` varchar(1024) CHARACTER SET utf8 NOT NULL DEFAULT '[]' COMMENT 'Array of resources accessible to user'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `user_master` (
  ...
  `password_salt_key` varchar(40) CHARACTER SET utf8 NOT NULL,
