...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2018 at 11:27 AM
...
--
-- Database: `api.cultofpassion.com`
--
...
(7, 'CLICKED', 'Clicked', 1, '{contact} clicked {link} from mail {entity}', 6, 1, 1, 1496645339, 1496645339),
...
(101, 'DOCUMENT_LINKS', 'Document Links', NULL, '', 3, 1, 0, 1496645339, 1496645339),
...
(105, 'VIEWED', 'Viewed', 101, '', 4, 1, 0, 1496645339, 1496645339),
...
(159, 'CLICKED', 'Clicked', 151, '{contact} clicked {link} from stage {stage} email of campaign {entity}', 8, 1, 1, 1496645339, 1496645339),
...
CREATE TABLE `api_messages` (
  `id` smallint(5) UNSIGNED NOT NULL,
  `code` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `error_message` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'API response message',
  `status` tinyint(2) UNSIGNED NOT NULL DEFAULT '1' COMMENT '0-Inactive, 1-Active',
  `created` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'GMT+00:00 Timestamp',
  `modified` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'GMT+00:00 Timestamp'
...
(76, 'OUTLOOK_USER_NOT_VERIFIED', 401, 2005, 'Please verify your account first then after try to login', 1, 0, 0);
...
CREATE TABLE `campaign_master` (
  ...
  `other_data` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '{}' COMMENT 'Campaign settings',
  `status_message` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Message describing status change of campaign',
...
CREATE TABLE `campaign_sequences` (
  ...
  `campaign_stage_id` bigint(20) UNSIGNED DEFAULT NULL,
  `account_contact_id` int(10) UNSIGNED DEFAULT NULL,
  `csv_payload` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `document_master` (
  ...
  `bucket_path` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
CREATE TABLE `query_error_log` (
  ...
  `error` varchar(2056) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `effected_rows` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
...
(4, 'Dashboard', 'Access to dashboard section.', '[\"/dashboard\", \"/students/list\", \"/students/create\", \"/students/{id}/update\", \"/students/{id}/view\", \"/students/{id}/delete\", \"/students/{id}/copy\", \"/students/hobbies-list\", \"/students/courses-list\", \"/students/cities-list\", \"/students/upload-image\"]', NULL, 4, 0, 0, 1, 1, 1, 1496645339, 1496645339),
...
(6, 'Feed', 'Access to user activity feed section.', '[\"/me/feed\",\"/users/list\", \"/users/{id}/view\", \"/users/{id}/login\"]', NULL, 6, 0, 0, 1, 1, 1, 1496645339, 1496645339),
...
(34, 'Campaigns / Update', 'Access to update campaigns data.', '[\"/campaigns/{id}/update\", \"/campaigns/{id}/snooze\", \"/campaigns/{id}/status-update\", \"/campaigns/{id}/sequence-delete/{seq_id}\",\"/campaigns/send-test-mail\",\"/campaigns/{id}/import-csv-data\"]', 9, 3, 1, 0, 0, 1, 1, 1496645339, 1496645339),
...
(1979, 200, 75, 1, 1518589840),
(1980, 201, 24, 1, 1516627635),
(1981, 202, 28, 1, 1516627647),
(1982, 203, 43, 1, 1516628324),
(1983, 203, 42, 1, 1516628324),
(1984, 203, 41, 1, 1516628324),
(1985, 204, 28, 1, 1516627683),
(1986, 204, 29, 1, 1516627683),
(1987, 203, 71, 1, 1516628324),
(1988, 203, 72, 1, 1516628324),
(1989, 203, 73, 1, 1516628324),
(1990, 203, 74, 1, 1516628324),
(1991, 203, 67, 1, 1516628324),
(1992, 205, 24, 1, 1516692858),
(1993, 205, 25, 1, 1516692858),
(1994, 205, 26, 1, 1516692858),
(1995, 205, 27, 1, 1516692858),
(1996, 205, 28, 1, 1516692858),
(1997, 205, 29, 1, 1516692858),
(1998, 205, 30, 1, 1516692858),
(1999, 205, 31, 1, 1516692858),
(2000, 205, 32, 1, 1516692858),
(2001, 205, 33, 1, 1516692858),
(2002, 205, 34, 1, 1516692858),
(2003, 205, 36, 1, 1516692858),
(2004, 205, 37, 1, 1516692858),
(2005, 205, 38, 1, 1516692858),
(2006, 205, 40, 1, 1516692858),
(2007, 205, 39, 1, 1516692858),
(2008, 205, 35, 1, 1516692858),
(2009, 205, 41, 2, 1516692858),
(2010, 205, 42, 2, 1516692858),
(2011, 205, 43, 2, 1516692858),
(2012, 205, 44, 2, 1516692858),
(2013, 205, 45, 2, 1516692858),
(2014, 205, 63, 2, 1516692858),
(2015, 205, 64, 2, 1516692858),
(2016, 205, 65, 2, 1516692858),
(2017, 205, 66, 2, 1516692858),
(2018, 205, 67, 2, 1516692858),
(2019, 205, 68, 2, 1516692858),
(2020, 205, 69, 2, 1516692858),
(2021, 205, 70, 2, 1516692858),
(2022, 206, 36, 1, 1516685848),
(2023, 206, 37, 1, 1516685848),
(2024, 206, 38, 1, 1516685848),
(2025, 206, 39, 1, 1516685848),
(2026, 206, 40, 1, 1516685848),
(2027, 206, 28, 1, 1516685848),
(2028, 206, 29, 1, 1516685848),
(2029, 206, 30, 1, 1516685848),
(2030, 206, 31, 1, 1516685848),
(2031, 206, 27, 1, 1516685848),
(2032, 206, 26, 1, 1516685848),
(2033, 206, 25, 1, 1516685848),
(2034, 206, 24, 1, 1516685848),
(2035, 205, 46, 2, 1516692858),
(2036, 205, 47, 2, 1516692858),
(2037, 205, 48, 2, 1516692858),
(2038, 205, 49, 2, 1516692858),
(2039, 205, 50, 1, 1516692858),
(2040, 205, 51, 1, 1516692858),
(2041, 205, 52, 1, 1516692858),
(2042, 205, 53, 1, 1516692858),
(2043, 205, 54, 1, 1516692858),
(2044, 205, 55, 2, 1516692858),
(2045, 205, 56, 2, 1516692858),
(2046, 205, 57, 2, 1516692858),
(2047, 205, 58, 2, 1516692858),
(2048, 205, 59, 2, 1516692858),
(2049, 205, 60, 2, 1516692858),
(2050, 205, 61, 2, 1516692858),
(2051, 205, 62, 2, 1516692858),
(2052, 205, 71, 2, 1516692858),
(2053, 205, 72, 2, 1516692858),
(2054, 205, 73, 2, 1516692858),
(2055, 205, 74, 2, 1516692858),
(2056, 205, 75, 2, 1516692858),
(2057, 205, 76, 2, 1516692858),
(2058, 205, 78, 2, 1516692858),
(2059, 205, 77, 2, 1516692858),
(2060, 205, 79, 2, 1516692858),
(2061, 205, 80, 2, 1516692858),
(2062, 205, 81, 2, 1516692858),
(2063, 205, 82, 2, 1516692858),
(2064, 205, 83, 2, 1516692858),
(2065, 205, 84, 2, 1516692858),
(2066, 205, 85, 2, 1516692858),
(2067, 207, 24, 2, 1516698473),
(2068, 207, 25, 2, 1516698473),
(2069, 207, 26, 2, 1516698473),
(2070, 207, 27, 2, 1516698473),
(2071, 207, 30, 2, 1516698473),
(2072, 207, 31, 2, 1516698473),
(2073, 207, 32, 2, 1516698473),
(2074, 207, 33, 2, 1516698473),
(2075, 207, 34, 2, 1516698473),
(2076, 207, 35, 2, 1516698473),
(2077, 207, 29, 2, 1516698473),
(2078, 207, 28, 2, 1516698473),
(2079, 207, 50, 1, 1516698473),
(2080, 207, 51, 1, 1516698473),
(2081, 207, 52, 1, 1516698473),
(2082, 207, 53, 1, 1516698473),
(2083, 207, 54, 1, 1516698473),
(2084, 207, 37, 1, 1516698473),
(2085, 207, 38, 1, 1516698473),
(2086, 207, 39, 1, 1516698473),
(2087, 207, 40, 1, 1516698473),
(2088, 207, 36, 1, 1516698473),
(2090, 209, 24, 1, 1518621492),
(2091, 209, 25, 1, 1518621492),
(2092, 200, 24, 1, 1518589840),
(2093, 200, 25, 1, 1518589841),
(2094, 200, 26, 1, 1518589841),
(2095, 200, 27, 1, 1518589841),
(2096, 200, 28, 1, 1518589841),
(2097, 200, 29, 1, 1518589841),
(2098, 200, 30, 1, 1518589841),
(2099, 200, 31, 1, 1518589841),
(2100, 200, 35, 1, 1518589841),
(2101, 200, 34, 1, 1518589841),
(2102, 200, 33, 1, 1518589841),
(2103, 200, 32, 1, 1518589842),
(2104, 200, 36, 1, 1518589842),
(2105, 200, 37, 1, 1518589842),
(2106, 200, 39, 1, 1518589842),
(2107, 200, 38, 1, 1518589842),
(2108, 200, 40, 1, 1518589842),
(2109, 200, 41, 1, 1518589842),
(2110, 200, 42, 1, 1518589842),
(2111, 200, 43, 1, 1518589842),
(2112, 200, 44, 1, 1518589842),
(2113, 200, 45, 1, 1518589842),
(2114, 200, 49, 1, 1518589842),
(2115, 200, 48, 1, 1518589843),
(2116, 200, 47, 1, 1518589843),
(2117, 200, 46, 1, 1518589843),
(2118, 200, 50, 1, 1518589843),
(2119, 200, 51, 1, 1518589843),
(2120, 200, 52, 1, 1518589843),
(2121, 200, 53, 1, 1518589843),
(2122, 200, 54, 1, 1518589843),
(2123, 200, 55, 1, 1518589843),
(2124, 200, 56, 1, 1518589843),
(2125, 200, 57, 1, 1518589843),
(2126, 200, 58, 1, 1518589843),
(2127, 200, 59, 1, 1518589843),
(2128, 200, 60, 1, 1518589844),
(2129, 200, 61, 1, 1518589844),
(2130, 200, 62, 1, 1518589844),
(2131, 200, 63, 1, 1518589844),
(2132, 200, 64, 1, 1518589844),
(2133, 200, 65, 1, 1518589844),
(2134, 200, 66, 1, 1518589844),
(2135, 200, 70, 1, 1518589844),
(2136, 200, 69, 1, 1518589844),
(2137, 200, 68, 1, 1518589844),
(2138, 200, 67, 1, 1518589844),
(2139, 200, 71, 1, 1518589844),
(2140, 200, 72, 1, 1518589845),
(2141, 200, 73, 1, 1518589845),
(2142, 200, 74, 1, 1518589845),
(2143, 200, 76, 1, 1518589845),
(2144, 200, 77, 1, 1518589845),
(2145, 200, 78, 1, 1518589845),
(2146, 200, 80, 1, 1518589845),
(2147, 200, 79, 1, 1518589845),
(2148, 200, 81, 1, 1518589845),
(2149, 200, 82, 1, 1518589845),
(2150, 200, 83, 1, 1518589845),
(2151, 200, 84, 1, 1518589845),
(2152, 200, 85, 1, 1518589845),
(2153, 209, 28, 1, 1518621492),
(2154, 209, 32, 1, 1518621492),
(2155, 209, 36, 1, 1518621492),
(2156, 209, 41, 1, 1518621492),
(2157, 209, 46, 1, 1518621492),
(2158, 209, 50, 1, 1518621493),
(2159, 209, 55, 1, 1518621493),
(2160, 209, 67, 1, 1518621493),
(2161, 209, 59, 1, 1518621493),
(2162, 209, 63, 1, 1518621493),
(2163, 209, 71, 1, 1518621493),
(2164, 209, 75, 1, 1518621493),
(2165, 209, 77, 1, 1518621493),
(2166, 209, 79, 1, 1518621493),
(2167, 209, 81, 1, 1518621493),
(2168, 209, 85, 1, 1518621493),
(2169, 209, 33, 1, 1518621493),
(2170, 209, 34, 1, 1518621494),
(2171, 209, 35, 1, 1518621494),
(2172, 209, 29, 1, 1518621494),
(2173, 209, 26, 1, 1518621494),
(2174, 209, 30, 1, 1518621494),
(2175, 209, 27, 1, 1518621494),
(2176, 209, 31, 1, 1518621494),
(2177, 209, 47, 1, 1518621494),
(2178, 209, 48, 1, 1518621494),
(2179, 209, 49, 1, 1518621494),
(2180, 209, 51, 1, 1518621494),
(2181, 209, 52, 1, 1518621494),
(2182, 209, 53, 1, 1518621495),
(2183, 209, 54, 1, 1518621495),
(2184, 209, 76, 1, 1518621495),
(2185, 209, 60, 1, 1518621495),
(2186, 210, 28, 1, 1518678865),
(2187, 210, 29, 1, 1518678865),
(2188, 210, 30, 1, 1518678865),
(2189, 210, 31, 1, 1518678865),
(2190, 210, 24, 1, 1518678865),
(2191, 210, 25, 1, 1518678865),
(2192, 210, 26, 1, 1518678865),
(2193, 210, 27, 1, 1518678865),
(2194, 210, 75, 1, 1518678865),
(2195, 211, 24, 1, 1518678971),
(2196, 212, 24, 1, 1518693161),
(2197, 212, 28, 1, 1518693162),
(2198, 212, 32, 1, 1518693162),
(2199, 212, 33, 1, 1518693162),
(2200, 212, 37, 1, 1518693162),
(2201, 212, 34, 1, 1518693162),
(2202, 212, 35, 1, 1518693162),
(2203, 212, 38, 1, 1518693162),
(2204, 212, 39, 1, 1518693162),
(2205, 212, 42, 1, 1518693162),
(2206, 212, 43, 1, 1518693162),
(2207, 212, 44, 1, 1518693162),
(2208, 212, 46, 1, 1518693162),
(2209, 212, 47, 1, 1518693163),
(2210, 212, 48, 1, 1518693163),
(2211, 212, 52, 1, 1518693163),
(2212, 213, 24, 1, 1518958538),
(2213, 213, 29, 1, 1518958538),
(2214, 213, 34, 1, 1518958538),
(2215, 213, 39, 1, 1518958538),
(2216, 213, 45, 1, 1518958538);
...
(200, 1, 1, 1, 'Software Developer', 'Software Developer', '', 0, 1, 1, 1516598674, 1518589840),
(201, 11, 15, 1, 'Software developer', 'Software developer', '', 0, 1, 1, 1516627635, 1516627635),
(202, 11, 15, 1, 'QA', 'QA', '', 0, 1, 1, 1516627647, 1516627647),
(203, 11, 15, 1, '123456789', '123456789', '', 0, 1, 1, 1516627659, 1516628324),
(204, 11, 15, 1, '!@#$%^&*()', '!@#$%^&*()', '', 0, 1, 1, 1516627683, 1516627683),
(205, 11, 16, 1, 'PHP developer', 'PHP developer', '', 0, 1, 1, 1516685815, 1516692857),
(206, 11, 16, 1, 'Java developer', 'Java developer', '', 0, 1, 1, 1516685848, 1516685848),
(207, 11, 34, 1, 'Python developer', 'Python developer', '', 0, 1, 1, 1516697031, 1516698473),
(209, 9, 13, 1, 'as', 'Full', 'as', 0, 1, 2, 1517380707, 1518679669),
(210, 9, 13, 1, 'IT Team Email Tracking', 'IT Team Email Tracking', 'email tracking only', 0, 1, 1, 1518678864, 1518678864),
(211, 9, 13, 1, 'Full', 'Full', '', 0, 1, 1, 1518678971, 1518678971),
(212, 3, 4, 1, 'New Role 1', 'New Role 1', 'recruiting, training and supervising staff.', 0, 1, 1, 1518693161, 1518693161),
(213, 3, 4, 1, 'Test Role', 'Test Role', 'This is test role', 0, 1, 1, 1518958538, 1518958538);
...
CREATE TABLE `student` (
  ...
  `college_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `gender` tinyint(1) UNSIGNED NOT NULL DEFAULT '1' COMMENT '0-Female, 1-Male',
  `hobies` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `courses` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `city` tinyint(3) UNSIGNED NOT NULL,
  `entolled` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0-No, 1-Yes',
...
CREATE TABLE `user_master` (
  ...
  `sh_referer` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
ALTER TABLE `role_default_resources`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2217;
