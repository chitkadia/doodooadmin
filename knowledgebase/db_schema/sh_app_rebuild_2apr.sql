...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2018 at 09:37 AM
...
CREATE TABLE `document_link_visits` (
  ...
  `modified` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `viewed_mail_sent` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0: No, 1: Yes'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `error_logs` (
  ...
  `user_id` int(10) UNSIGNED NOT NULL,
  `source_id` tinyint(3) UNSIGNED NOT NULL COMMENT '1: WEB_APP, 2: CHROME_PLUGIN, 3: OUTLOOK_PLUGIN',
  `error` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `occurred_at` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'GMT+00:00 Timestamp'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(91, 'Token Expire', 'User\'s Authentication Tokens', '[\"/user/expire-token\"]', NULL, 91, 0, 0, 1, 1, 1, 1521191883, 1521191883),
(92, 'Error Logs', 'Store errors', '[\"/error-logs/post\"]', NULL, 91, 0, 0, 1, 1, 1, 1521191883, 1521191883);
