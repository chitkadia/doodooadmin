...
CLASS PROSPECTS EXTENDS GENERALFUNCTIONS {
	...
	print "counter :: " . $counter . "\n";
	 			...
	 			if(!empty($strInsertValues)) {
	 				...
	 				$qryIns = "	INSERT INTO account_companies (id, account_id, source_id, name, address, city, state, country, zipcode, logo, website, contact_phone, contact_fax, short_info, total_mail_sent, total_mail_failed,total_mail_replied, total_mail_bounced, total_link_clicks, total_document_viewed, total_document_facetime, status, created, modified)
